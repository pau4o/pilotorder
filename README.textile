...
h2. FastGettext configuration (we don't use gettext)
...
FastGettext.add_text_domain 'pilotorder', :path => 'locale', :type => :po
FastGettext.default_available_locales = ['en','bg'] #all you want to allow
FastGettext.default_text_domain = 'pilotorder'
...
touch locale/en/pilotorder.po
touch locale/bg/pilotorder.po
